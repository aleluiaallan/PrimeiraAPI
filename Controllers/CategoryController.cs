...
namespace Blog.Controllers
{
    public class CategoryController : ControllerBase
    {
            ...
            [FromServices] BlogDataContext context)
        {
            ...
            {
                return StatusCode(500, new ResultViewModel<Category>("05EX02 - Falha interna no servidor"));
            }
        }
            ...
            [FromServices] BlogDataContext context)
        {
            ...
            {
                return StatusCode(500, new ResultViewModel<Category>("05EX09 - Não foi possível incluir a categoria"));
            }
            ...
            [FromServices] BlogDataContext context)
        {
            ...
            {
                return StatusCode(500, new ResultViewModel<Category>("05EX08 - Não foi possível alterar a categoria"));
            }
            ...
            [FromServices] BlogDataContext context)
        {
            ...
            {
                return StatusCode(500, new ResultViewModel<Category>("05EX07 - Não foi possível deletar a categoria"));
            }
